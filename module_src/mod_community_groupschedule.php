...
*/
    ...
    //Your Upcoming
    $useraccept = $groupsModel->getGroupScheduleAcceptListWithCreator($userid);
    $useracceptfg = $findModel->getGolfersScheduleAcceptListWithCreator($userid);
    ...
    $pendingfg = $findModel->getSchedulePendingList($userid);
    
    //Pending Requests
    $pendingRequests = $groupsModel->getGroupScheduleListCloseNoAccepts($userid);
